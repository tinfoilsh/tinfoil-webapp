          ...
          <div className="mt-4">
            ...
            >
              ...
              <input
                ...
                autoComplete="off"
                className="mt-1 w-full rounded-lg border border-border-subtle bg-surface-input px-3 py-2 text-sm text-content-primary placeholder:text-content-muted focus:outline-none"
              />
