...
function CountdownTimer({
  ...
  // The timer counts down from mount — `pausedRemainingMs === null` means
  // running, `number` means paused at that remaining duration. Starting in
  // the running state matches user intent for "set a 5 minute timer";
  // requiring an explicit Start click felt broken in user testing.
  ...
  const secondaryActionLabel =
    remaining.done || hasStarted ? 'Restart' : 'Reset'
