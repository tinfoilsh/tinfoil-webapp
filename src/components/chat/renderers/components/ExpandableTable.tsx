...
export function ExpandableTable({ children }: ExpandableTableProps) {
  ...
  const chevronBase =
    'pointer-events-auto flex h-7 w-7 items-center justify-center rounded-full border border-border-subtle bg-white text-content-secondary shadow hover:text-content-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-border-strong dark:bg-zinc-800'
